...
fs.readFile('/Users/postman/Documents/personnel/proj/Team-Eagle/logifier/assests/testfile.txt', 'utf8', function(err, data){
    var str = data.split("\n");
    var even_odd = 0
    var result = {}
    k = 0
    ...
    for (const key in result) {
        try {
            var retVal = processedData(result[key].metadata.tableName, result[key].data);
